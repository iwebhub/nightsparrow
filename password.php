  ...
  if (isset($_POST['email'])) {
   ...
   // echo 'a';
    ...
    if ($userExists == true) {
      ...
      $setPasswordResetToken = $ns->setUserPasswordResetToken($_POST['email'], $passwordResetToken, $_SERVER['REMOTE_ADDR']);
      ...
      $emailResult = $ns->sendEmail($_POST['email'], 'Izaberite novu lozinku za {{sitename}}', 'forgotPassword.html', $emailValues);
