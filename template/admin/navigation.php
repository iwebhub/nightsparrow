<nav class="light-blue">
  <div class="nav-wrapper">
    ...
    <ul class="right hide-on-med-and-down">
      ...
      <?php if(($ns->getSettingValue('pluginManager', 'pluginManager:Enabled') == true) && ($ns->getSettingValue('pluginManager', 'analytics:Enabled'))){
        echo '<li><a href="analytics.php">Analitika</a></li>';
      }
      ?>
      <li><a href="user.php?id=<?php echo $ns->getSessionUser($_COOKIE['ns_sid']); ?>"><i class="mdi-social-person" style="font-size:18px;"></i> <?php echo $loggedInUser; ?></a>
      </li>
    ...
    <ul class="side-nav" id="mobile-demo">
      ...
      ?>
      <hr>
      <li><a href="user.php?id=<?php echo $ns->getSessionUser($_COOKIE['ns_sid']); ?>"><i class="mdi-social-person"></i><?php echo $loggedInUser; ?></a></li>
