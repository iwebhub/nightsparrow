<div class="container"><div class="pageEditor">
<div class="row">
  <form class="col s12" action="index.php" method="post">
    ...
    <div class="row">
      ...
      <div class="input-field col s12">
        ...
        <input id="siteName" name="siteName" type="text" class="validate" value="<?php if (isset($data)) {
          echo $data['siteName'];
        } ?>">
    ...
    <div class="row">
      <div class="input-field col s12">
        ...
        <textarea name="siteDescription" class="materialize-textarea" required><?php if(isset($data)){echo $data['siteDescription'];}?></textarea>
...
<div class="row">
  <div class="input-field col s12">
    ...
    <p>
      <input name="siteType" type="radio" value="company" id="company" <?php if ($data['siteType'] == 'company') {
        echo 'checked';
      } ?> />
    ...
    <p>
      <input name="siteType" value="project" type="radio" id="project"<?php if ($data['siteType'] == 'project') {
        echo 'checked';
      } ?>/>
...
<p>Konfiguracija</p>
    ...
    <p>
      ...
      <label for="analyzeStatus">Omogući analitiku <small>(pruža dodatak <b>Analyze</b> autora <b>Nightsparrow</b>)</small></label>
  ...
  <!--  <p>
    ...
    <div class="row">
      <div class="input-field col s12">
        <input id="postsPerPage" name="postsPerPage" value="<?php if(isset($data)){echo $data['postsPerPage'];}?>" type="number" min="1" max="100" class="validate" required>
    ...
    <div class="row">
      <div class="input-field col s12">
        ...
        <textarea name="headerContent" class="materialize-textarea"><?php if(isset($data)){echo $data['headerContent'];}?></textarea>
    ...
    <div class="row">
      <div class="input-field col s12">
        ...
        <textarea name="footerContent" class="materialize-textarea"><?php if(isset($data)){echo $data['footerContent'];}?></textarea>

      </div>

      <div class="row">
        <div class="input-field col s12">
          <input id="logoLink" name="logoLink" type="text" class="validate" value="<?php if (isset($data)) {
            echo $data['logoLink'];
          } ?>">
