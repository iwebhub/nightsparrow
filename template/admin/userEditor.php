<div class="row">
  <form class="col s12" action="index.php" method="post">
    ...
    <input type="hidden" name="selfaction" value="<?php if(isset($data)){ echo $data['self']; } ?>">
    <input type="hidden" name="csrfToken" value="<?php echo $csrfToken; ?>">

    <div class="row">
      <div class="input-field col s6">
        <input id="email" type="email" name="email" class="validate" required value="<?php if(isset($data)){ echo $data['email']; } ?>">
    ...
    <div class="row">
      <div class="input-field col s12">
        <input id="name" name="name" type="text" class="validate" required value="<?php if(isset($data)){ echo $data['name']; } ?>">
...
<?php if($data['self'] === false){ ?>
    <div class="row">
      <div class="input-field col s12">
        <input id="level" name="level" type="number" min="1" max="10" class="validate" required value="<?php if(isset($data)){ echo $data['level']; } ?>">
