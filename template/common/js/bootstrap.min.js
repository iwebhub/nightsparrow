...
+function (t) {
  ...
  i.VERSION = "3.2.0", i.DEFAULTS = {
    ...
    if (this.hasContent() && this.enabled) {
      ...
      var a = "function" == typeof this.options.placement ? this.options.placement.call(this, n[0], this.$element[0]) : this.options.placement, r = /\s?auto?\s?/i, l = r.test(a);
      ...
      var h = this.getPosition(), d = n[0].offsetWidth, p = n[0].offsetHeight;
      if (l) {
        var c = a, f = this.$element.parent(), u = this.getPosition(f);
        a = "bottom" == a && h.top + h.height + p - u.scroll > u.height ? "top" : "top" == a && h.top - u.scroll - p < 0 ? "bottom" : "right" == a && h.right + d > u.width ? "left" : "left" == a && h.left - d < u.left ? "right" : a, n.removeClass(c).addClass(a)
      }
      var g = this.getCalculatedOffset(a, h, d, p);
      this.applyPlacement(g, a);
      var m = function () {
        o.$element.trigger("shown.bs." + o.type), o.hoverState = null
      };
      t.support.transition && this.$tip.hasClass("fade") ? n.one("bsTransitionEnd", m).emulateTransitionEnd(150) : m()
    }
    ...
    var p = d.left ? 2 * d.left - n + l : 2 * d.top - s + h, c = d.left ? "left" : "top", f = d.left ? "offsetWidth" : "offsetHeight";
  ...
  t.fn.collapse = e, t.fn.collapse.Constructor = i, t.fn.collapse.noConflict = function () {
    ...
    var o, n = t(this), s = n.attr("data-target") || i.preventDefault() || (o = n.attr("href")) && o.replace(/.*(?=#[^\s]+$)/, ""), a = t(s), r = a.data("bs.collapse"), l = r ? "toggle" : n.data(), h = n.attr("data-parent"), d = h && t(h);
    r && r.transitioning || (d && d.find('[data-toggle="collapse"][data-parent="' + h + '"]').not(n).addClass("collapsed"), n[a.hasClass("in") ? "addClass" : "removeClass"]("collapsed")), e.call(a, l)
  })
}(jQuery), +function (t) {
  "use strict";
  function e() {
